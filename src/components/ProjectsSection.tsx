...
function ProjectCard({ project, featured }: ProjectCardProps) {
  ...
  return (
    <div className={`bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 ${featured ? 'h-full' : ''
      }`}>
      {/* Project Image or Icon Section */}
      {project.image && !imageError ? (
        // With Image - Using 16:9 aspect ratio for landscape fullscreen appearance
        ...
        // Without Image - Enhanced design with larger icon and gradient (16:9 ratio)
        <div className="relative w-full bg-gradient-to-br from-purple-100 via-blue-100 to-indigo-100 flex flex-col items-center justify-center overflow-hidden" style={{ aspectRatio: '16/9' }}>
          {/* Background Pattern */}
